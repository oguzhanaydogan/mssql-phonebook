...
conn_string = "Driver='{ODBC Driver 18 for SQL Server}';Server=tcp:{database_host},1433;Database={database_name};Uid={database_user};Pwd={database_password};Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
